...
export function Signup() {
  ...
  const setGenericErrorAlert = useSetRecoilState(signUpErrorAlert);
  const setUserExistsErrorAlert = useSetRecoilState(userExistsErrorAlert);
