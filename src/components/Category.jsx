...
import { selectedCatAtom, filteredAtomsByCat } from "../store/atoms/todoAtoms";
...
function Category() {
  ...
  async function deleteCategories(cat){
    console.log("CAT: ", cat)
    const res = await axios.delete('http://localhost:3000/api/v1/category/deleteCategory', {
      data: cat,  // The request body is passed here
    });
